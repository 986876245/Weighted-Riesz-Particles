...
# Load the run
load("/home/daixiongming/Documents/Code/pmh-tutorial-2.1/r/savedWorkspaces/example3-sv.RData")
...
if (savePlotToFile) {
cairo_pdf("/home/daixiongming/Documents/Code/pmh-tutorial-2.1/r/figures/example4-sv-plotProposals.pdf",
          height = 6,
          width = 8)
}
